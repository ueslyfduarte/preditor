...
class MaquinaOverallV28:
    ...
    def calcular_bloco_resistencia(self, time_pressao: Dict[str, float], liga_pressao: Dict[str, float], jogo_atual_time: Dict[str, Any]) -> Dict[str, float]:
        """Executa o Passo 1-D: Bloco de Resistência à Pressão corrigido para ler listas de histórico"""
        # Extrai o primeiro jogo da lista de histórico defensivo se ela não estiver vazia
        ...
        # Puxa os dados brutos decimais usando travas seguras para evitar novos erros de chave (KeyError)
